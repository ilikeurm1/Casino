...
def bet(money: int) -> tuple[int, int]:
    ...
    while 1:
        ...
        m = Prompt.ask(
            ...
            "[b]'b'[/b]:     'billion',\n"
            "[b]'t'[/b]:     'trillion',\n"
            "[b]'quad'[/b]:  'quadrillion',\n"
            "[b]'quint'[/b]: 'quintillion',\n"
            "[b]'sext'[/b]:  'sextillion',\n"
            "[b]'sept'[/b]:  'septillion',\n"
            "[b]'o'[/b]:     'octillion',\n"
            "[b]'n'[/b]:     'nonillion',\n"
            ...
            "\n"
            "Example input:\n"
            "7t 1t 5m 123 10k 9sept 5000 k m \n"
            "A value without a number like ^ will be treated as 1 * val\n"
            "[/blue][green]\n"
            f"You have [white]{money}$[/white] ([white]{convert_number_to_string(money)}[/white])\n"
            "Type [white]'0'[/white] to go [b]all in[/b] and [white]'0.5'[/white] to bet [b]half[/]"
        )
